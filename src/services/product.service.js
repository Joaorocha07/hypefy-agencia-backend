...
async function createProduct(role, data, file) {
  ...
  const created = await prisma.product.create({
    data: {
      ...
      isManualDelivery: payload.isManualDelivery ?? false,
      hasScreens: payload.hasScreens ?? true,
      acceptsCustomComments: payload.acceptsCustomComments ?? false,
      imageUrl,
    },
    include: CATEGORY_PLATFORM_SELECT,
  });
